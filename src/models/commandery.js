...
module.exports = class Commandery {
  constructor(
    id,
    registration_id,
    picture,
    ...
    this.parish = parish;
    this.commandery_no = commandery_no;
    this.dob = dob;
    ...
    this.to_11 = to_11;
    this.doi = doi;
    this.commandery_of_initiation = commandery_of_initiation;
    this.init_no = init_no;
    this.comm_transferred = comm_transferred;
    this.no_of_comm_transferred = no_of_comm_transferred;
    this.second_dg_date = second_dg_date;
    this.fourth_dg_date = fourth_dg_date;
    this.date_other = date_other;
  ...
  save() {
    return db.query(
      'INSERT INTO commandery (registration_id,picture,title,gender,surname,othername,parish,commandery_no,dob,place_of_birth,nationality,postal_address,residential_address,telephone,cellphone,email,hometown,region,occ_status,profession,place_of_work,work_address,office_phone,position_1,position_supr_1,from_1,to_1,position_2,position_supr_2,from_2,to_2,position_3,position_supr_3,from_3,to_3,position_4,position_supr_4,from_4,to_4,position_5,position_supr_5,from_5,to_5,position_6,position_supr_6,from_6,to_6,position_7,position_supr_7,from_7,to_7,position_8,position_supr_8,from_8,to_8,position_9,position_supr_9,from_9,to_9,position_10,position_supr_10,from_10,to_10,position_11,position_supr_11,from_11,to_11,doi,commandery_of_initiation,init_no,comm_transferred,no_of_comm_transferred,second_dg_date,fourth_dg_date,date_other,honour_1,date_honour_1,honour_2,date_honour_2,honour_3,date_honour_3,honour_4,date_honour_4,honour_5,date_honour_5,marriage_status,date_of_marriage,spouse,marriage_type,child_1,dob_of_child_1,child_2,dob_of_child_2,child_3,dob_of_child_3,child_4,dob_of_child_4,child_5,dob_of_child_5,date_of_baptism,first_communion,date_of_confirmation,service_parish) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)',
      [
        ...
        this.to_11,
        this.doi,
        this.commandery_of_initiation,
        this.init_no,
        this.comm_transferred,
        this.no_of_comm_transferred,
        this.second_dg_date,
        this.fourth_dg_date,
        this.date_other,
        this.honour_1,
