...
module.exports = {
    ...
    saveDataCommandery: (req, res) => {
        ...
        if (image_upload.mimetype === 'image/png' || image_upload.mimetype === 'image/jpeg' || image_upload.mimetype === 'image/gif') {
            image_upload.mv(`public/assets/img/${image_name}`, image_upload, (err) => {
                if (err) {
